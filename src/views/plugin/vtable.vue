...
const columns: VTableGantt.ColumnsDefine = [
  {
    field: 'title',
    title: 'TASK',
    width: '200',
...
onMounted(() => {
  ganttInstance = new VTableGantt.Gantt(document.getElementById('vtable-gantt') as HTMLElement, option);
})
...
<template>
  <div class="p-16">
    <el-card class="card-w">
      <div id="vtable-gantt" class="h-500px w-100%" style="position: relative;"></div>
    </el-card>
  </div>
</template>