...
const getNodeWidth = (nodeId: any, isRoot: any) => {
...
const getNodeSize = (nodeId: any, isRoot: any) => {
...
function render() {
  const rootId = antvData.id;

  const graph = new Graph({
    data: treeToGraphData(antvData),
    node: {
      type: 'mindmap',
      // @ts-ignore
      style: function (d) {
